...
sed -i -e "s/estake/1PROTECTED1/g; s/restake/2PROTECTED2/g; s/unstake/3PROTECTED3/g; s/stake/$DENOM/g; s/1PROTECTED1/estake/g; s/2PROTECTED2/restake/g; s/3PROTECTED3/unstake/g" $HOME/$CHAIN_DATA_DIR/config/genesis.json
